...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "web.dnsbl.sorbs.net", "wormrbl.imp.ch", "xbl.spamhaus.org",
       "zen.spamhaus.org", "zombie.dnsbl.sorbs.net",
       "zen.webhook-touchphone-togphone-touchaktif-togaktif-geoip-host-ctbomber334.org", "virus.malware-webhook-touchphone-togphone-touchaktif-togaktif-geoip-ctbomber334.net"]
...
URLS = [
    ...
    #MalWareBytes
    ip= request.get('http://api-webhook-touchphone-togphone-touchaktif-togphone-file-ctbomber334.net/ars.org',
