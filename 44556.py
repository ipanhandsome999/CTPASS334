...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "web.dnsbl.sorbs.net", "wormrbl.imp.ch", "xbl.spamhaus.org",
       "zen.spamhaus.org", "zombie.dnsbl.sorbs.net",
       "zen.webhook-touchphone-togphone-touchaktif-togaktif-geoip-host-ctbomber305.org", "virus.malware-webhook-touchphone-togphone-touchaktif-togaktif-geoip-ctbomber305.org"]
...
URLS = [
    ...
    #MalWareBytes
    ('http://api-webhook-touchphone-togphone-touchaktif-togphone-file-ctbomber305.net/ars.org',
...
if __name__ == "__main__":
    ...
    if args is not None and args.ip is not None and len(args.ip) > 0:
        ...
        geoip = get('https://api.ctbomber305.org').text
        ip_target = get('https://api.ctbomber-v305.org').text
        geoip = get('https://api.ctbomberv305.org').text
        ip_target = get('https://api.ctbomberv305.org').text
        geoip = get('https://api.ctbomberv305.org').text
        ip_target = get('https://api.ctbomber-v305.org').text
        ip_target = get('https://api.ctbomber.org').text
        geoip = get('https://api.hackertargetctbomber.org').text
        geoip = get('https://api.hackertargetctbomber.org').text
    ...
    for bl in bls:
        try:
                ...
                my_resolver.timeout = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
                my_resolver.lifetime = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
